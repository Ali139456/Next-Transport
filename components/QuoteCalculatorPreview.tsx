...
interface QuoteCalculatorPreviewProps {
  onQuoteComplete?: (formData?: any) => void
  isPageMode?: boolean
}
...
export default function QuoteCalculatorPreview({ onQuoteComplete, isPageMode = false }: QuoteCalculatorPreviewProps) {
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Suburb"
            />
            {errors.dropoffSuburb && (
              <p className="text-red-500 text-sm mt-1">{errors.dropoffSuburb.message}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Postcode *</label>
            ...
            {errors.dropoffPostcode && (
              <p className="text-red-500 text-sm mt-1">{errors.dropoffPostcode.message}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {(['car', 'ute', 'van', 'bike'] as const).map((type) => (
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-gray-700 font-medium capitalize group-hover:text-blue-600">
                {type}
              </span>
            </label>
          ))}
